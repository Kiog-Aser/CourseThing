...
-- CreateEnum
CREATE TYPE "public"."LessonKind" AS ENUM ('VIDEO', 'TEXT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Lesson_courseId_slug_key" ON "public"."Lesson"("courseId", "slug");
...
-- AddForeignKey
ALTER TABLE "public"."Lesson" ADD CONSTRAINT "Lesson_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
